...
import (
	...
	hello "github.com/amikai/go_project_starter/src/hello"
	hellopb "github.com/amikai/go_project_starter/src/internal/gen/hello/v1"
)
...
func main() {
	...
	var (
		service    = hello.NewService(logger, counter)
		endpoints  = hello.NewEndpoints(service, logger, duration, tracer, zipkinTracer)
		grpcServer = hello.NewGRPCServer(endpoints, tracer, zipkinTracer, logger)
	)
	...
	}
	{
		...
		g.Add(func() error {
			...
			hellopb.RegisterHelloServiceServer(baseServer, grpcServer)
